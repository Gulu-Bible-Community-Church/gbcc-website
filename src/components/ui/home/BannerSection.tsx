	...
	return (
		<section className="relative -z-10 lg:mx-0 mx-4 flex flex-row items-center h-auto w-full lg:pt-28 md:pt-24 pt-24">
			...
			<div className='relative z-10 w-1/2'>
				...
				<div className='absolute lg:top-24 md:top-24 top-10 lg:-right-24 md:right-0 right-4 lg:w-80 md:w-40 w-16 lg:h-80 md:h-40 h-16 bg-[#D67314] rounded-full -z-10'></div>

			</div>
			{/* right section */}
			<div className='w-1/2'>
				<div
					className='relative z-10 lg:text-6xl md:text-3xl text-[12px] text-[#162352] font-bold '
				...
				>
					...
					<motion.p
						className='absolute text-white bg-[#162352] text-center lg:text-[30px] text-[10px] lg:p-2 rounded-md p-1 z-10'
						initial={{ opacity: 0, }}
						animate={{ opacity: 1, }}
						transition={{ ease: "easeIn", duration: 2, delay: 2 }}
						exit={{ opacity: 0 }}
