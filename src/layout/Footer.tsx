...
const Footer = () => {
  return (
    <footer className=" bg-gradient-to-b from-[#162352] to-[#222020] text-white mt-10 " >
      <div className="flex lg:flex-row flex-col justify-between lg:items-center px-4 bg-[#222020] py-7 pb-4">
        <h1 className="lg:text-4xl md:text-3xl text-2xl md:mb-0 mb-6 lg:leading-normal font-semibold md:w-2/5 w-full text-center">
          <span className="text-[#D67314] px-2">Subscribe</span>
          for our newsletter
        </h1>
